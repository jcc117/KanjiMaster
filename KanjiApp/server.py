...
def add_data():
	...
	db.session.add(Kanji(2, '学期','gakki', 1))
	db.session.add(Kanji(3, '時期','jiki', 1))
	db.session.add(Kanji(4, '期間','kikan', 1))
	db.session.add(Kanji(5, '期待','kitai', 1))
	db.session.add(Kanji(6, '期末','kimatsu', 1))
	db.session.add(Kanji(7, '','', 0))
	db.session.add(Kanji(8, '','', 0))
	db.session.add(Kanji(9, '','', 0))
	db.session.add(Kanji(10, '','', 0))
	db.session.add(Kanji(11, '','', 0))
	db.session.add(Kanji(12, '','', 0))
	db.session.add(Kanji(13, '','', 0))
	db.session.add(Kanji(14, '','', 0))
	db.session.add(Kanji(15, '','', 0))
	db.session.add(Kanji(16, '','', 0))
	db.session.add(Kanji(17, '','', 0))
	db.session.add(Kanji(18, '','', 0))
	db.session.add(Kanji(19, '','', 0))
	db.session.add(Kanji(20, '','', 0))
	db.session.add(Kanji(21, '','', 0))
	db.session.add(Kanji(22, '','', 0))
	db.session.add(Kanji(23, '','', 0))
	db.session.add(Kanji(24, '','', 0))
	db.session.add(Kanji(25, '','', 0))
	db.session.add(Kanji(26, '','', 0))
	db.session.add(Kanji(27, '','', 0))
	db.session.add(Kanji(28, '','', 0))
	db.session.add(Kanji(29, '','', 0))
